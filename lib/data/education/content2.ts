...
export const TOOL_EDUCATION_2: ToolEducation[] = [
  ...
  // ── Tool 9: EV Chart ───────────────────────────────────────────────
  {
    slug: 'ev-chart',
    beginner:
      'Exposure Value (EV) is a single number that describes the total amount of light hitting your sensor. Each whole EV step represents a doubling or halving of light. For example, EV 15 is a bright sunny day, while EV 2 is a dimly lit night street.',
    deeper:
      'EV is defined as EV = log₂(N² / t), where N is the f-number and t is the shutter speed in seconds. At ISO 100, each integer EV corresponds to a specific luminance level. Changing ISO shifts the effective EV: raising ISO by one stop (e.g., 100 to 200) adds 1 to the effective EV. The EV chart shows all aperture-and-shutter combinations that produce the same exposure — any cell with the same EV number will yield an identical exposure at the same ISO. This is the principle behind "equivalent exposures": f/2.8 at 1/500 gives the same exposure as f/5.6 at 1/125, because both are EV 13. Understanding this grid helps you quickly find alternative settings when you need to prioritize depth of field or motion control.',
    keyFactors: [
      { label: 'Aperture', description: 'Each full stop wider (lower f-number) halves the EV — doubles the light reaching the sensor.' },
      { label: 'Shutter Speed', description: 'Each full stop longer doubles the light, reducing EV by 1.' },
      { label: 'ISO Sensitivity', description: 'ISO does not change the light captured but shifts the effective EV for metering purposes. Each doubling of ISO adds 1 EV.' },
      { label: 'Lighting Condition', description: 'Real-world scenes range from about EV -4 (starlight) to EV 16+ (bright sand or snow in direct sun).' },
    ],
    tips: [
      { text: 'Use the lighting condition selector to highlight all aperture/shutter combos that match a scene. Then pick the combo that best suits your creative needs — wide aperture for bokeh or fast shutter for freezing action.' },
      { text: 'The Sunny 16 rule is a quick EV sanity check: on a bright sunny day (EV 15), f/16 at 1/ISO gives correct exposure. For example, f/16 at 1/100 at ISO 100.' },
      { text: 'When shooting in manual mode, count the EV difference between cells to understand how many stops you need to compensate when changing one setting.' },
    ],
    tooltips: {
      'Lighting Condition': {
        term: 'Lighting Condition',
        definition: 'A preset scene brightness measured in EV at ISO 100. Selecting a condition highlights all aperture/shutter combinations in the chart that match that light level.',
      },
      Aperture: {
        term: 'Aperture',
        definition: 'The size of the lens opening, expressed as an f-number. Lower f-numbers mean more light and shallower depth of field.',
      },
      Shutter: {
        term: 'Shutter',
        definition: 'How long the sensor is exposed to light. Longer shutter speeds capture more light but introduce motion blur.',
      },
      'EV (ISO 100)': {
        term: 'EV (ISO 100)',
        definition: 'The exposure value at base ISO. Higher numbers mean brighter scenes or less light reaching the sensor per exposure.',
      },
    },
    challenges: [
      {
        id: 'ev-beginner-1',
        difficulty: 'beginner',
        scenario: 'You are standing outside on a bright, sunny day. Which lighting condition should you select to see the matching exposure combinations?',
        hint: 'Clear direct sunlight is the brightest common outdoor condition.',
        successMessage: 'Correct! Bright sun corresponds to EV 15, the highest typical outdoor value.',
        failureMessage: 'On a clear sunny day, the lighting condition is "Bright sun" at EV 15.',
        targetField: 'lightingCondition',
        options: [
          { label: 'Bright sun (EV 15)', value: 'bright-sun' },
          { label: 'Cloudy (EV 12)', value: 'cloudy' },
          { label: 'Indoor normal (EV 6)', value: 'indoor' },
        ],
        correctOption: 'bright-sun',
      },
      {
        id: 'ev-beginner-2',
        difficulty: 'beginner',
        scenario: 'In the chart, you see that f/4 at 1/1000 shows EV 14. If you want the same exposure but more depth of field, which combination has the same EV?',
        hint: 'Stopping down the aperture by 2 stops means you need 2 stops more shutter time.',
        successMessage: 'Right! f/8 at 1/250 is also EV 14 — you traded 2 stops of aperture for 2 stops of shutter speed.',
        failureMessage: 'Look for a cell with the same EV number. Narrowing aperture from f/4 to f/8 is 2 stops, so the shutter needs to slow by 2 stops too.',
        targetField: 'cell',
        options: [
          { label: 'f/8 at 1/250', value: 'f8-250' },
          { label: 'f/8 at 1/1000', value: 'f8-1000' },
          { label: 'f/2 at 1/1000', value: 'f2-1000' },
        ],
        correctOption: 'f8-250',
      },
      {
        id: 'ev-intermediate-1',
        difficulty: 'intermediate',
        scenario: 'You are shooting indoors at EV 6 (ISO 100). Your lens opens to f/1.4 maximum. What is the slowest shutter speed you can see in the chart for this combination?',
        hint: 'Find the cell at f/1.4 that shows EV 6.',
        successMessage: 'Correct! At f/1.4, EV 6 corresponds to a shutter speed of about 1/8 second at ISO 100.',
        failureMessage: 'Look at the f/1.4 column and find the row where the EV value reads 6. That shutter speed is your answer.',
        targetField: 'cell',
        options: [
          { label: '1/8 second', value: '1/8' },
          { label: '1/60 second', value: '1/60' },
          { label: '1 second', value: '1s' },
        ],
        correctOption: '1/8',
      },
      {
        id: 'ev-intermediate-2',
        difficulty: 'intermediate',
        scenario: 'You found a correct exposure at f/5.6 and 1/60s (EV 11, open shade). Now you want to shoot at f/2 for subject separation. By how many stops must you increase shutter speed?',
        hint: 'Count the stops between f/5.6 and f/2.',
        successMessage: 'Exactly! f/5.6 to f/2 is 3 stops wider, so you need a shutter speed 3 stops faster — from 1/60 to 1/500.',
        failureMessage: 'The aperture scale goes f/2 → f/2.8 → f/4 → f/5.6. That is 3 full stops, so the shutter must speed up by 3 stops as well.',
        targetField: 'cell',
        options: [
          { label: '2 stops faster (1/250)', value: '2' },
          { label: '3 stops faster (1/500)', value: '3' },
          { label: '4 stops faster (1/1000)', value: '4' },
        ],
        correctOption: '3',
      },
      {
        id: 'ev-advanced-1',
        difficulty: 'advanced',
        scenario: 'You are at a night street scene (EV 2). Your camera is at ISO 100, f/1.4. The chart shows you need a very long shutter. If you raise ISO to 3200, how does the required shutter speed change?',
        hint: 'ISO 100 to 3200 is 5 stops (100→200→400→800→1600→3200).',
        successMessage: 'Perfect! Raising ISO by 5 stops lets you use a shutter speed 5 stops faster. Instead of multiple seconds, you are now in handholdable territory.',
        failureMessage: 'ISO 100 to 3200 is 5 doublings (5 stops). Each stop of ISO lets you use a shutter speed one stop faster, so the shutter gets 5 stops faster in total.',
        targetField: 'cell',
        options: [
          { label: '3 stops faster', value: '3' },
          { label: '5 stops faster', value: '5' },
          { label: '7 stops faster', value: '7' },
        ],
        correctOption: '5',
      },
    ],
