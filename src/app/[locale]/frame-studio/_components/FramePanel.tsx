      ...
      {isCustom && (
        <>
          <div className={styles.section}>
            ...
            <input type="range" min={0} max={400} step={25} value={config.borderWidth} onChange={(e) => update('borderWidth', parseInt(e.target.value))} className={styles.slider} />
            <div className={styles.tickMarks}>
              {Array.from({ length: 17 }, (_, i) => <span key={i} className={styles.tick} />)}
            </div>
          </div>
