...
export const TOOLS: ToolDef[] = [
  ...
  { slug: 'shutter-speed-visualizer', name: 'Shutter Speed Visualizer', description: 'Find the minimum safe shutter speed for sharp handheld shots', dev: 'live', prod: 'draft', category: 'visualizer' },
